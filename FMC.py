...
dc = Non-double couple component \n\
...
for row in range(n_events):
    if args.i[0] == 'CMT':
        ...
        Mo, fclvd, val, vect, iso, dc = moment(am)
...
#Added by Felix
dcH = vstack(((['DC']),(array(dc_all, dtype=object))))
